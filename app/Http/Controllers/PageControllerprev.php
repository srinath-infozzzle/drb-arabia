...
*/
        ...
        // Replace the first occurrence
        $tempen=["menu" => $menuen, 'common' => $commonen, 'mainpage' => $mainpageen, 'camps' => $campsen, 'testimonial' => $testimonialen, 'footercolumn' => $footercolumnen, 'footerlinks' => $footerlinksen,'faq'=> $faqen,
...
$tempar=["menu" => $menuar, 'common' => $commonar, 'mainpage' => $mainpagear, 'camps' => $campsar, 'testimonial' => $testimonialar, 'footercolumn' => $footercolumnar, 'footerlinks' => $footerlinksar,'faq'=> $faqar,
