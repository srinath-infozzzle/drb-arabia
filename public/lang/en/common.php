<?php return [
    ...
    "DRB_Nomad_Find_out_More_Description" => "Lorem ipsum dolor sit amet consectetur. Accumsan id facilisis eget enim nibh tempor.
                                ...
                                elementum nunc venenatis varius vel. Habitant eget dictumst magnis massa.",
    "View_More_Button" => "View More",
    "View_All_Button" => "View All",
    "Contact_Us_Title" => "Contact Us",
    "Contact_Us_Phone" => "Phone",
    "Contact_Us_Phone_Subtitle" => "Lorem ipsum",
    "Contact_Us_Email" => "Email",
    "Contact_Us_Email_Subtitle" => "Lorem ipsum",
    "Contact_Us_Description" => "Get in touch with us to create your ideal stay in the heart of Saudi Arabia.",
    "Contact_Us_Name" => "Name",
    "Contact_Us_Enter Message" => "Enter Message",
    "Send_ Message" => "Send Message",
